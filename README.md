...
<p align="center">
  <b>Flutter Developer</b> • <b>Mobile App Engineer</b> • <b>CS Graduate</b>
</p>
...
I'm a **Computer Science graduate** from *Federal Urdu University of Arts, Science and Technology*, focused on building **cross-platform mobile apps** with Flutter and Firebase.

- 📱 Main focus: **Flutter & app development**
- 🔥 Solid with the Firebase ecosystem — Auth, Firestore, Realtime Database, Cloud Storage
- 💡 Like clean architecture, offline-first design, and polished UI/UX
...
> An offline-first health companion app with an AI-powered wellness assistant.
...
### 📈 ICT Backtester Pro
> An event-driven algorithmic backtesting engine for ICT price action concepts.
...
- **BSCS** — Federal Urdu University of Arts, Science and Technology (Graduate)
